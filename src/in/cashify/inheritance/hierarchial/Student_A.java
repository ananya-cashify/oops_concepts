...
public  class Student_A extends teacher{
    ...
    public static void main (String [] args){
        ...
        B1.Lecture1(Boolean.TRUE);
        B1.Lecture2(Boolean.FALSE);
        Student_A A1 =new Student_A("Maths");
        Student_A A2 =new Student_A("English");
        B1.Lecture3(Boolean.TRUE);
        B1.Lecture4(Boolean.FALSE);
        Student_C C1 = new Student_C("Maths");
        C1.Lecture5(Boolean.TRUE);
